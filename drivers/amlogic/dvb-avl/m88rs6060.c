...
static int m88rs6060_set_voltage(struct dvb_frontend *fe, fe_sec_voltage_t voltage)
{
	struct m88rs6060_state *state = fe->demodulator_priv;
	u8 data;
...
static int m88rs6060_read_status(struct dvb_frontend *fe, fe_status_t* status)
{
	struct m88rs6060_state *state = fe->demodulator_priv;
	int lock = 0;
...
static int m88rs6060_set_tone(struct dvb_frontend *fe, fe_sec_tone_mode_t tone)
{
	struct m88rs6060_state *state = fe->demodulator_priv;
	u8 data_a1, data_a2;
